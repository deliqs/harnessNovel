...
- For format migrations, test the canonical English write/emit path and the supported Chinese or older read/parse/delete path. Keep Stage and Phase cases separate.
